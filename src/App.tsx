...
/** Маленькая цифра + тонкая линия для крупных блоков */
function SectionLabel({ n, title }: { n: number; title: string }) {
  const num = String(n).padStart(2, "0");
  return (
    <div className="flex items-center gap-3 mb-6" aria-hidden="true">
      <span className="inline-flex items-center justify-center w-7 h-7 rounded-full border border-slate-200 text-[11px] font-semibold text-slate-500">
        {num}
      </span>
      <span className="h-[1px] w-16 bg-slate-200" />
...
export default function App() {
  ...
  useEffect(() => {
    ...
    }, 12000 + Math.random() * 8000); // Каждые 12–20 сек
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* ===== 01. HERO: фото-фоном + синие акценты ===== */}
      <section
        id="hero"
        className="relative min-h-[88vh] flex items-center pt-24"
        style={{
          backgroundImage:
            "linear-gradient(to right, rgba(255,255,255,1) 0%, rgba(255,255,255,0.9) 35%, rgba(255,255,255,0) 65%), url('/images/hero.jpg')",
      ...
      >
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 w-full">
          <SectionLabel n={1} title="главный экран" />
      ...
      <section id="comparison" className="py-20 bg-gray-50">
        <div className="max-w-6xl mx-auto px-6">
          <SectionLabel n={2} title="сравнение" />
            ...
            <div className="bg-white rounded-2xl p-8 border border-gray-200 hover:shadow-lg transition-all duration-300 hover:-translate-y-1 animate-slide-in-left">
              ...
              <ul className="space-y-4 text-gray-800">
                {[
                  ...
                  <li
                    key={i}
                    className="flex gap-3 hover:bg-red-50 p-2 rounded-lg transition-colors"
                  >
                    <svg
            ...
            <div className="bg-white rounded-2xl p-8 border border-gray-200 hover:shadow-lg transition-all duration-300 hover:-translate-y-1 animate-slide-in-right">
              ...
              <ul className="space-y-4 text-gray-800">
                {[
                  ...
                  <li
                    key={i}
                    className="flex gap-3 hover:bg-green-50 p-2 rounded-lg transition-colors"
                  >
                    <svg
                      className="w-5 h-5 mt-1 text-green-600 flex-shrink-0"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
      ...
      <section id="why" className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          <SectionLabel n={3} title="почему это важно" />
      ...
      {/* ===== 04. КОМУ ПОДХОДЯТ СКРИПТЫ ===== */}
      <section id="for" className="py-20 bg-gray-50">
        <div className="max-w-6xl mx-auto px-6">
          <SectionLabel n={4} title="для кого" />
      ...
      {/* ===== 05. ЧТО ВХОДИТ В СИСТЕМУ ===== */}
      <section id="whats-included" className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          <SectionLabel n={5} title="что входит" />
          <div className="text-center animate-fade-in">
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900">
      ...
      <section id="immediate" className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-6">
          <SectionLabel n={7} title="что изменится сразу" />
          <h2 className="text-3xl lg:text-4xl font-bold text-center text-gray-900 animate-fade-in">
      ...
      {/* ===== 08. ОТЗЫВЫ: фото + Instagram embeds ===== */}
      <section id="reviews" className="py-20 bg-gray-50">
        <div className="max-w-6xl mx-auto px-6">
          <SectionLabel n={8} title="отзывы" />
          ...
          {/* Рилсы из инсты: узкие, 9:16, скролл по горизонтали; не растягиваем */}
          <div className="flex gap-4 justify-center items-start mb-8 overflow-x-auto pb-2 reels-row">
            {INSTAGRAM_REELS.map((url) => (
              <div key={url} className="flex-shrink-0">
                <InstaEmbed url={url} maxWidth={280} />
              </div>
            ))}
          </div>
        </div>
      ...
      <section id="offer" className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-6">
          <SectionLabel n={9} title="предложение" />
                    ...
                    <ul className="space-y-2 text-sm text-gray-200">
                      {[
                        ...
                        <li key={i} className="flex gap-2 items-start">
                          <span className="w-4 h-4 mt-0.5 text-green-400 flex-shrink-0">
                            ✓
                          </span>
                          <span>{t}</span>
                        </li>
      ...
      <section id="faq" className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-6">
          <SectionLabel n={10} title="частые вопросы" />
          <h2 className="text-3xl lg:text-4xl font-bold text-center text-gray-900 animate-fade-in">
            Частые вопросы
          </h2>
