  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section
        ...
        style={{ backgroundImage: "url('/images/hero6.jpg')", backgroundSize: "cover", backgroundPosition: "right center" }}
      >
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 w-full">
          <div className="max-w-2xl">
            ...
            <p className="text-xl text-gray-700 mb-8 leading-relaxed">
              Проверенная система общения с клиентами для бьюти-мастеров. Результат: <span className="text-blue-600 font-semibold">закрытые возражения</span>, <span className="text-blue-600 font-semibold">увеличенный средний чек</span>, <span className="text-blue-600 font-semibold">экономия времени</span>.
            </p>
            <div className="flex items-center gap-4">
              <a
                href={STRIPE_URL}
              ...
              >
                Купить <span className="inline-block ml-1 transition-transform group-hover:translate-x-1">→</span>
              </a>
      ...
      {/* ===== ОТЗЫВЫ: фото + Instagram embeds (компактные, не растягиваем) ===== */}
      <section id="reviews" className="py-20 bg-gray-50">
        <div className="max-w-6xl mx-auto px-6">
          ...
          {/* Рилсы из инсты: узкие, 9:16, скролл по горизонтали */}
