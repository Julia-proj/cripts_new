...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Floating online counter (СКРЫТ НА МОБИЛЕ) */}
      <div className="fixed bottom-4 left-4 z-40 hidden md:block">
        <div className="flex items-center gap-2 text-sm text-gray-700 bg-white/95 backdrop-blur-md px-4 py-2.5 rounded-full shadow-lg border border-gray-200">
      ...
      <header className="fixed top-0 left-0 right-0 bg-white/90 backdrop-blur-md z-50 border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <div className="flex items-center gap-4">
            {/* Счетчик посетителей (мобилка скрыт — UX чище) */}
      ...
      {/* HERO: фото как ЕДИНЫЙ ФОН без фильтров + текст в карточке */}
      <section
      ...
      >
        <div className="max-w-7xl mx-auto w-full px-6 py-28">
          <div className="max-w-xl bg-white/90 backdrop-blur-[2px] rounded-2xl p-6 md:p-8 shadow-xl">
            ...
            <p className="text-lg md:text-xl text-gray-700 mb-6">
              Проверенная система общения для бьюти-мастеров:{" "}
              <span className="text-red-600 font-semibold">закрытые возражения</span>,{" "}
              <span className="text-blue-600 font-semibold">увеличенный средний чек</span>, экономия времени.
            </p>
            <a
              href={STRIPE_URL}
              target="_blank"
              rel="noopener"
              className="inline-flex items-center gap-3 px-7 py-3.5 bg-gray-900 text-white rounded-xl text-lg font-semibold hover:bg-gray-800 transition-all hover:-translate-y-0.5 hover:shadow-xl"
            >
            ...
            <div className="mt-4 flex items-center gap-3 text-xs text-gray-600">
              ...
              <span className="hidden sm:inline">• Доступ сразу</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="comparison" className="py-16 md:py-20 bg-gray-50">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid lg:grid-cols-2 gap-8 max-w-5xl mx-auto mt-10 md:mt-12">
            <div className="bg-white rounded-2xl p-6 md:p-8 border border-gray-200 hover:shadow-lg transition-all duration-300 hover:-translate-y-1 animate-slide-in-left">
            ...
            <div className="bg-white rounded-2xl p-6 md:p-8 border border-gray-200 hover:shadow-lg transition-all duration-300 hover:-translate-y-1 animate-slide-in-right">
              <div className="text-center mb-6">
      ...
      <section id="why" className="py-16 md:py-20 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-6 md:gap-8 mt-10 md:mt-12">
            <div className="rounded-2xl border p-6 md:p-8 text-center hover:shadow-lg transition-all duration-300 hover:-translate-y-1 animate-zoom-in">
      ...
      <section id="whats-included" className="py-16 md:py-20 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mt-10 md:mt-12">
            {[
              {
      ...
      <section id="reviews" className="py-16 md:py-20 bg-gray-50">
        <div className="max-w-6xl mx-auto px-6">
          <h2 className="text-3xl lg:text-4xl font-bold text-center text-gray-900 mb-10 md:mb-12 animate-fade-in">
            Отзывы клиентов
          </h2>
          ...
          {/* Видео отзывы (Instagram embeds) — КОМПАКТНО, БЕЗ ДЕФОРМАЦИИ */}
          <div className="flex gap-3 md:gap-4 justify-center items-start flex-wrap">
            {INSTAGRAM_REELS.map((url, i) => (
              <div key={i} className="bg-white rounded-xl border p-2 shadow-sm">
                {/* На мобилке делаем ещё компактнее */}
                <div className="block md:hidden">
                  <InstaEmbed url={url} maxWidth={240} />
                </div>
                <div className="hidden md:block">
                  <InstaEmbed url={url} maxWidth={320} />
                </div>
              </div>
            ))}
          </div>
